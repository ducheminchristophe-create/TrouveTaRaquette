...
const MODULES = [
  {
    ...
    emoji: '🎾',
    name: 'Tennis',
    tagline: 'Raquette et cordage personnalisés',
    desc: 'Trouve ta raquette idéale parmi 222 modèles ou reçois des recommandations de cordage personnalisées selon ton profil.',
    cta: 'Accéder au tennis',
    ready: true,
    badge: null,
  },
  {
